"""jobwright HTML Dashboard Generator.
...
from jobwright import config as ap_config
...
def generate_dashboard(output_path: str | None = None) -> str:
    ...
    Args:
        output_path: Where to write the HTML file. Defaults to ~/.jobwright/dashboard.html.
...
<title>jobwright Dashboard</title>
<style>
