...
def set_proxy(proxy_str: str | None):
    ...
    if proxy_str:
        from jobwright.discovery.jobspy import parse_proxy
...
def _load_base_urls() -> dict[str, str | None]:
    ...
    from jobwright.config import load_base_urls
...
def extract_with_llm(page, url: str) -> dict:
    ...
    try:
        ...
        from jobwright.discovery.smartextract import extract_json
