---
name: advisor
description: Escalates to a stronger readonly advisor when execution is stuck: PLAN, CORRECTION, or STOP. Use for hard forks, contract risk, or repeated failure.
---
