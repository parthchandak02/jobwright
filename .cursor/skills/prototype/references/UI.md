...
navigation convention. Name it so it is obviously a prototype. Use the same
...
- The project's existing component library and styling system.
...
Point at the surface and the variant toggle. The most useful feedback is
usually "I want the header from B with the sidebar from C" - that is the real
design taking shape.
